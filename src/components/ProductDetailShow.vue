      ...
      <div class="row row-cols-1 mt-3" style="width: 50%; margin: auto;">
        <div class="col mb-4">
          <div class="card" >
            ...
            <div class="card-body">
              <h6 class="card-title mt-3">{{ product.Price }}</h6>
              <p class="card-text" style="font-size: 1.7ch;">{{ product.Des2 }}</p>
              <div class="panelbuttcon">
                <div class="buttcon" >
                  <div class="input-group mb-2">
                    <span class="input-group-text quatitybuttbgminus"><button class="quatitybutt" @click="storeProduct.decrement"><img class="imgbutt" src="@/assets/minus.png" alt=""></button></span>
                    ...
                    <span class="input-group-text quatitybuttbgplus"><button class="quatitybutt" @click="storeProduct.increment"><img class="imgbutt" src="@/assets/plus.png" alt=""></button></span>
                  </div>  
                </div>
              </div>
              <div class="panelbuttcon">
